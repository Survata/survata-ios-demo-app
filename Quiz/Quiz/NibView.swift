...
open class KernLabel: UILabel {
    ...
    open var attributes: [NSAttributedStringKey: Any] {
        ...
        return [
            kCTFontAttributeName as NSAttributedStringKey: font,
            kCTForegroundColorAttributeName as NSAttributedStringKey: textColor,
            kCTKernAttributeName as NSAttributedStringKey: kern as Any,
            kCTParagraphStyleAttributeName as NSAttributedStringKey: style,
        ]
    }
